    ...
    <>
      ...
      >
        Create an account or Sign in
                ...
                <h4>
                  Super-charge your design workflow now <br /> and start
                  collaborating like a beast
                </h4>
              </div>
            ...
            <div className="how-it-works">
              ...
              <div className="step">
                <div className="icons">
                  <img
                    src={allinoneicon}
                    className="icons collaborate-icon"
              ...
              <div className="step">
                <div className="icons">
                  <img
                    src={messagingicon}
                    className="icons messaging-icon"
                    alt="messaging icon"
                  />
                </div>
                <h5>Step 3</h5>
            ...
            <div className="inspiration">
              <div className="inspiration-screenshot">
                <img
                  ...
                  alt="Explore page screen shot image"
                />
              </div>
              <div className="inspiration-text">
                <h5>Find inspiration from your fellow designers</h5>
                <p>
                  Not sure where to start? Check out projects by other designers
                  on the Explore page for inspiration!
                </p>
              </div>
            </div>
          </Element>
          <Element className="features">
            <div className="features-heading">
              <h3>
                DesignHub is built for designers<br></br>by designers
              </h3>
            </div>
            <div className="feature-box">
              ...
              <h5>Messaging</h5>
              <p>
                Easily reach out to other designers through the messaging
                feature
              </p>
            </div>
            <div className="feature-box">
              ...
              <h5>Heatmap</h5>
              <p>
                Track your contributions, and have a visual representation to
                share
              </p>
            </div>
            <div className="feature-box">
            ...
            <div className="feature-box">
              ...
              <h5>Feedback</h5>
              <p>
                Give and receive feedback on projects easily including using
                sticky comments to comment directly on a specific element of the
                design
              </p>
            </div>
          </Element>
          ...
          <img className="arrow" src={arrow} onClick={scrollToTop} />
